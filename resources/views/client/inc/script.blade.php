...
<!-- latest jquery -->
<script src="/assets/client/assets/js/jquery-3.6.0.min.js"></script>
<script src="/assets/client/assets/js/jquery-ui.min.js"></script>

<!-- Bootstrap js -->
<script src="/assets/client/assets/js/bootstrap/bootstrap.bundle.min.js"></script>
<script src="/assets/client/assets/js/bootstrap/bootstrap-notify.min.js"></script>
<script src="/assets/client/assets/js/bootstrap/popper.min.js"></script>

<!-- feather icon js -->
<script src="/assets/client/assets/js/feather/feather.min.js"></script>
<script src="/assets/client/assets/js/feather/feather-icon.js"></script>

<!-- Lazyload js -->
<script src="/assets/client/assets/js/lazysizes.min.js"></script>

<!-- Slick js -->
<script src="/assets/client/assets/js/slick/slick.js"></script>
<script src="/assets/client/assets/js/slick/slick-animation.min.js"></script>
<script src="/assets/client/assets/js/slick/custom_slick.js"></script>

<!-- Auto Height js -->
<script src="/assets/client/assets/js/auto-height.js"></script>

<!-- WOW js -->
<script src="/assets/client/assets/js/wow.min.js"></script>
<script src="/assets/client/assets/js/custom-wow.js"></script>

<!-- script js -->
<script src="/assets/client/assets/js/script.js"></script>

<!-- theme setting js -->
<script src="/assets/client/assets/js/theme-setting.js"></script>
<!-- latest jquery -->
<script src="/assets/client/assets/js/jquery-3.6.0.min.js"></script>
<script src="/assets/client/assets/js/jquery-ui.min.js"></script>
